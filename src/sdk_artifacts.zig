...
fn controlCategory(control_type: unified.ControlType) []const u8 {
    return switch (control_type) {
        ...
        .venom_bind, .venom_upsert, .venom_get, .packages_list, .packages_catalog, .packages_updates, .packages_update, .packages_update_all, .packages_get, .packages_channel_get, .packages_channel_set, .packages_channel_clear, .packages_install, .packages_enable, .packages_switch, .packages_disable, .packages_rollback, .packages_remove => "venom",
