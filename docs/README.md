...
- `protocols/spiderweb-control-control.md` - canonical generated control protocol reference
- `protocols/acheron-runtime-v1.md` - canonical generated Acheron runtime reference
- `protocols/node-fs-spiderweb-control.md` - canonical generated node FS reference
